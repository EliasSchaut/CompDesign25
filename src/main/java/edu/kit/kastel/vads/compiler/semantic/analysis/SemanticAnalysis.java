...
import edu.kit.kastel.vads.compiler.semantic.analysis.typed.TypeAnalysis;
...
public class SemanticAnalysis {
    ...
    public void analyze() {
        this.program.accept(new ContextRecursivePostorderVisitor<>(new TypeAnalysis()), new TypedContext());
